...
$config = array(
  'servers' => array(
    array(
      'name'   => 'hxqc-env-test', // Optional name.
      'host'   => '10.0.15.207',
      'port'   => 6379,
      'filter' => '*',
    ...
    array(
      'name'   => 'hxqc-env-pre', // Optional name.
      'host'   => 'IP',
      'port'   => 6379,
      'filter' => '*',
      'scheme' => 'tcp', // Optional. Connection scheme. 'tcp' - for TCP connection, 'unix' - for connection by unix domain socket
     ...
     array(
      'name'   => 'aliyun server', // Optional name.
      'host'   => 'IP',
      'port'   => 6379,
      'filter' => '*',
      'scheme' => 'tcp', // Optional. Connection scheme. 'tcp' - for TCP connection, 'unix' - for connection by unix domain socket
      ...
      // Optional Redis authentication.
      'auth' => 'phpRedisAdmin' // Warning: The password is sent in plain-text to the Redis server.
    ),
